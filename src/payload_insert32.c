...
{
	Elf32_Ehdr *main_header = &((payload_info32 *) info->payload)->main_header_replace;
	size_t injection_offset = ((payload_info32 *) info->payload)->insertion_header.p_offset + ((payload_info32 *) info->payload)->insertion_header.p_filesz;
	...
	Elf32_Phdr *ph_headers = executable->addr + main_header->e_phoff;
